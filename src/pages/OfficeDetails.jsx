...
import { FaClock, FaUserTie, FaSchool, FaPhone, FaCalendarAlt, FaBell, FaChalkboardTeacher } from 'react-icons/fa';
    ...
    <div className="w-full bg-white">
      ...
      <div className="container mx-auto px-4 py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 border border-[#f0e6d2] hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 relative overflow-hidden">
            ...
            <div className="space-y-4 text-gray-700">
              <div className="bg-[#f9f5f0] p-3 rounded-lg">
                ...
                <ul className="space-y-2 pl-6">
                  <li className="relative before:absolute before:left-0 before:top-2 before:w-1.5 before:h-1.5 before:rounded-full before:bg-[#541212] before:-left-4">
                    9:30 am – 11:00 am
                  </li>
                  <li className="relative before:absolute before:left-0 before:top-2 before:w-1.5 before:h-1.5 before:rounded-full before:bg-[#541212] before:-left-4">
                    12:30 pm – 1:30 pm
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 border border-[#f0e6d2] hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 relative overflow-hidden">
            ...
            <div className="space-y-4 text-gray-700">
              ...
              {/* <div className="text-center mt-6">
                <button className="bg-[#541212] text-white px-4 py-2 rounded-full text-sm font-medium hover:bg-[#3a0d0d] transition flex items-center gap-2 mx-auto">
                  <FaPhone />
                  Book Appointment
                </button>
              </div> */}
      ...
      {/* Contact Section */}
      <div className="bg-[#ebd8b4] py-12 relative overflow-hidden">
        <div className="absolute inset-0 opacity-10 bg-[url('https://mccsblr.edu.in/wp-content/uploads/2023/06/pattern.png')]"></div>
        <div className="container mx-auto px-4 text-center relative z-10">
          <h2 className="text-3xl font-bold text-[#541212] mb-6">CONTACT US</h2>
          <p className="text-lg text-gray-700 max-w-2xl mx-auto mb-6">
            For any inquiries, please contact the school office during working hours.
          </p>
          <button className="bg-[#541212] text-white px-6 py-3 rounded-full font-medium hover:bg-[#3a0d0d] transition flex items-center gap-2 mx-auto">
            <FaPhone />
